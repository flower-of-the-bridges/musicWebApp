...
<body>
	...
	<div class="container text-center">
		...
		<div class="col-sm-7 well">
			...
			{else}
			<h4>The song you are viewing is{if $song->isForRegisteredOnly()}for logged users.{elseif $song->isForSupportersOnly}for {$song->getArtist()->getNickName()}'s supporters.{elseif}hidden.{/if}<h4>
			{/if}
			<br>
			<br>
