<?php
/* Smarty version 3.1.32, created on 2018-05-14 18:25:39
  from '/opt/lampp/htdocs/DeepMusic/smarty/templates/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5af9b883db16b4_23685239',
...
function content_5af9b883db16b4_23685239 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en"><head>
...
<div class="container text-center well">
  ...
  <p>Are you tired of the same old songs? Do you want something new? </p>
  <h3>This is the place where music lives again.</h3>
  <br>
  <div class="row">
    <div class="col-sm-4">
      <p class="text-center"><strong>Create your Music!</strong></p><br>
      
        <img src="http://www.chrismcintyre.ca/wp-content/uploads/2015/06/Chris-McIntyre-5930.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
      
    </div>
    <div class="col-sm-4">
      <p class="text-center"><strong>Share it!</strong></p><br>
        <img src="https://s3.amazonaws.com/musicindustryhowtoimages/wp-content/uploads/2014/04/12072723/How-To-Get-People-To-Listen-To-Your-Music.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
     
     
    </div>
    <div class="col-sm-4">
      <p class="text-center"><strong>Be a Star!</strong></p><br>
      
        <img src="https://thumbs.dreamstime.com/t/silhouettes-people-music-festival-beach-41699585.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
